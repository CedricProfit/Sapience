...
const string strMessageMagic = "Sapience Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Sapience", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block        
        const char* pszTimestamp = "11/18/2014 washingtonpost.com - Why Elon Musk is scared of artificial intelligence";
        CTransaction txNew;
        txNew.nTime = 1416387829;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416387829;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 255041 : 255041;
	...
	printf("block.nNonce = %u \n", block.nNonce);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9676a8e6ae71b6049a5c45165b2ffe54b6f1bbd028782abc6c12c9338c1534db"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xb2, 0xef, 0xf2 };
